...
%aspectratio=149：140mm，90mm
%aspectratio=54：125mm，100mm
%aspectratio=43：128mm，96mm，默认尺寸
%aspectratio=32：135mm，90mm
\documentclass[xcolor=svgnames, t, aspectratio=169]{ctexbeamer}

%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
% 设置主题文件的文件夹(如'/styles')
\usepackage{styles/nwafubeamermacros}
\usefolder{styles}
      ...
      \begin{forest}
        ...
        [jobname【工作根目录】%, 
          [nwafulogo【学校校徽图标，\alert{必须存在}，且置于根目录】
            [nwafu-logo-circle.pdf【学校圆形透明Logo】, file
            ]
            [nwafu-bar-h-bw.pdf【学校横条形中英文黑字透明Logo】, file
            ]
            [nwafu\_waves.pdf【波纹背景透明图】, file
            ]
            [nwafu-college-logo.png【学院透明Logo】, file
            ]
          ]
		  ...
		  [styles【Beamer主题文件夹，\alert{必须存在}，建议不要更改文件夹名称】
            [beamerthemenwafusidebar.sty【主题主文件，\alert{必须存在}】, file
            ]
            [beamerinnerthemenwafusidebar.sty【内部主题文件，\alert{必须存在}】, file
            ]
            [beamerouterthemenwafusidebar.sty【外部主题文件，\alert{必须存在}】, file
            ]
            [beamercolorthemenwafusidebar.sty【颜色主题文件，\alert{必须存在}】, file
            ]
            [beamerfontthemenwafusidebar.sty【字体主题文件，\alert{必须存在}】, file
            ]
            [nwafubeamermacros.sty【用于设置主题文件文件夹的宏包，\alert{必须存在}】, file
            ]
		  ]
...
\begin{frame}[fragile]{关于我们}
  ...
  \begin{center}
      ...
      \matrix [below=\seplinedistance of hl1,%
        ...
        \node{\faEnvelope}; & \node{nangeng@nwafu.edu.cn};\\
        \node{\faGithub}; & \node{\url{https://gitee.com/nwafu_nan}}; \\
      };
      % sep line 2
