...
序 \lstinline!expand_mnist.py! 来这样做\footnote{\lstinline!expand_mnist.py! 的代
  ...
  \href{https://github.com/mnielsen/neural-networks-and-deep-learning/blob/master/src/expand_mnist.py}{%
    这里}获取。}：
\input{supplements/snippets/run_expand_mnist} % move to separate file to avoid syntax error caused by '$' in EMACS.
...
使用\hyperref[sec:how_to_choose_a_neural_network's_hyper-parameters]{好的\gls*{weight}初始
