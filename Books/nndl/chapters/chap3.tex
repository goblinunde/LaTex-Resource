...
\end{center}
你将看到如下的一系列变化：\label{saturation2_anchor}\label{saturation}
\begin{center}
...
\hyperref[ch:HowTheBackpropagationAlgorithmWorks]{上一章的问题中} 我指出我们可以使用矩阵技术来对所有在
...
\label{sec:other_techniques_for_regularization}
...
\label{sec:other_models_of_artificial_neuron}
